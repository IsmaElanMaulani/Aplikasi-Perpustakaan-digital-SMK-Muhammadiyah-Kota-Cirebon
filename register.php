...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/logoapp.png">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/logoapp.png" height="80px" width="80px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
            ...
            <p style="text-align: center; font-size: 13px;">SMK Muhammadiyah Kota Cirebon. &copy; <?= date('Y'); ?> .<?= $row1['nama_app']; ?> .</p>
